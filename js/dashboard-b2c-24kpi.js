/* =====================================================
   B2C DASHBOARD PRO MAX PLUS - ULTRA PREMIUM
   FULL KPI MODULES • SAFE PRODUCTION
===================================================== */
...
window.B2C24KPI = (function () {
  ...
  const render=api=>{
    ...
    renderSummary(api); renderKpiGrid(api.data); applyKpiHighlightAndTooltip(); hideSkeleton();
